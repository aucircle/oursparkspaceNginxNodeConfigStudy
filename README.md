...
这是一篇公开教程，根据 MIT 协议开源共享。被授权人有权利使用、复制、修改、合并、出版发行、散布、再授权及贩售软件及软件的副本。被授权人可根据程序的需要修改授权条款为适当的内容。在软件和软件的所有副本中都必须包含版权声明和许可声明。

任何人都可以对教程提出意见，或者提出修改方案，但是本人保留最终决定是否采纳的权利。
